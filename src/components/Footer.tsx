...
export default function Footer() {
  ...
  return (
    <footer className="py-12 mt-12 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl mx-auto space-y-4">
          <p>
            This portfolio is <strong className="text-indigo-600 dark:text-indigo-400">Open Source</strong>.
          </p>
        ...
        <div className="mt-8 flex justify-center">
          <motion.a 
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:border-indigo-500 hover:text-indigo-600 dark:hover:border-indigo-400 dark:hover:text-indigo-400 transition-colors text-sm font-medium text-slate-700 dark:text-slate-300"
          >
