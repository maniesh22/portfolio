  ...
  useEffect(() => {
    const fetchSize = async () => {
      try {
        ...
        console.error("Failed to load resume size", error);
        setFileSize('PDF Format');
      }
    };
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
        ...
        <div className='space-y-6'>
          ...
          <div className='flex gap-4 pt-4'>
            {/* GitHub */}
            <motion.a href="https://github.com/maniesh22" target="_blank" rel="noreferrer" whileHover={{ y: -4 }} className='p-3 bg-slate-100 dark:bg-slate-800 rounded-xl hover:bg-[#2b3137] hover:text-white transition-colors group'>
            ...
            {/* LinkedIn */}
            <motion.a href="https://linkedin.com/in/manishinprajapati" target="_blank" rel="noreferrer" whileHover={{ y: -4 }} className='p-3 bg-slate-100 dark:bg-slate-800 rounded-xl hover:bg-[#0077b5] hover:text-white transition-colors'>
        ...
        <div className='space-y-4 pt-4 md:pt-0'>
          ...
          <motion.a
            href={resumePath} // Uses the dynamic path
            download
            whileHover={{ scale: 1.02 }} 
